...
internals.Response.prototype.message = function (statusMessage) {

    Hoek.assert(typeof statusMessage === 'string', 'Status code must be a string');
...
internals.Response.prototype._passThrough = function () {
    ...
    if (this.variety === 'stream' &&
        ...
        if (this.source.statusMessage &&
            !this.statusMessage) {
            this.statusMessage = this.source.statusMessage;                        // Stream is an HTTP response
        }
